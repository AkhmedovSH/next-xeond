...
function Request({ title, defaultActiveSelect = 1 }) {
	...
	useEffect(() => {
		console.log("Updating activeSelect:", defaultActiveSelect);
	...
	return (
		<>
			...
			<div className="modal fade layout" id="requestModal" tabIndex="-1" aria-labelledby="requestModalLabel" >
				<div className="modal-dialog modal-dialog-centered">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="requestModalLabel">ЗАЯВКА</h5>
